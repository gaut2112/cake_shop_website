...
<div id="wrapper">
	...
	<%
	if(request.getParameter("Remove1")!=null){
	session.setAttribute("item1",session.getAttribute("item2"));
	session.setAttribute("item2",session.getAttribute("item3"));
	session.setAttribute("item3",session.getAttribute("item4"));
	session.setAttribute("item4",session.getAttribute("item5"));
	session.setAttribute("item5",session.getAttribute("item6"));
	session.setAttribute("item6",session.getAttribute("item7"));
	session.setAttribute("item7",null);
	}
    else if(request.getParameter("Remove2")!=null){
	session.setAttribute("item2",session.getAttribute("item3"));
	session.setAttribute("item3",session.getAttribute("item4"));
	session.setAttribute("item4",session.getAttribute("item5"));
	session.setAttribute("item5",session.getAttribute("item6"));
    ...
    else if(request.getParameter("Remove3")!=null){
	session.setAttribute("item3",session.getAttribute("item4"));
	session.setAttribute("item4",session.getAttribute("item5"));
	session.setAttribute("item5",session.getAttribute("item6"));
	session.setAttribute("item6",session.getAttribute("item7"));
    ...
    else if(request.getParameter("Remove4")!=null){
	session.setAttribute("item4",session.getAttribute("item5"));
	session.setAttribute("item5",session.getAttribute("item6"));
	session.setAttribute("item6",session.getAttribute("item7"));
	session.setAttribute("item7",null);
	}
    else if(request.getParameter("Remove5")!=null){
	session.setAttribute("item5",session.getAttribute("item6"));
	session.setAttribute("item6",session.getAttribute("item7"));
	session.setAttribute("item7",null);
	}
    else if(request.getParameter("Remove6")!=null){
	session.setAttribute("item6",session.getAttribute("item7"));
	session.setAttribute("item7",null);
	}
    else if(request.getParameter("Remove7")!=null){
	session.setAttribute("item7",null);
	}
    ...
    psSelectRecord.setString(1,session.getAttribute("item1").toString());
    rsSelectRecord=psSelectRecord.executeQuery();
	rsSelectRecord.next();
	session.setAttribute("item1_rate",rsSelectRecord.getString("cake_rate"));
	session.setAttribute("item1_name",rsSelectRecord.getString("cake_name"));
	session.setAttribute("item1_price",Integer.parseInt(session.getAttribute("item1_rate").toString())*Integer.parseInt(session.getAttribute("item1_qty").toString()));
	session.setAttribute("total",session.getAttribute("item1_price"));
	%>
	<tr>
	<form action="remove.jsp">
	<td align="left"><%= session.getAttribute("item1_name")%></td>
	<td align="center"><%= session.getAttribute("item1")%></td>
	<td align="center"><%= session.getAttribute("item1_qty")%></td>
	<td align="center"><%= session.getAttribute("item1_rate")%></td>
	<td align="center"><%= session.getAttribute("item1_price")%></td>
	<td><input type="submit" name="Remove1" value="Remove"/></td>
	</form>
	</tr>
	<% } %>
	<%
	...
	session.setAttribute("total",Integer.parseInt(session.getAttribute("total").toString())+Integer.parseInt(session.getAttribute("item2_price").toString()));
	%>
	<tr><form action="remove.jsp">
	...
	session.setAttribute("total",Integer.parseInt(session.getAttribute("total").toString())+Integer.parseInt(session.getAttribute("item3_price").toString()));
	%>
	<tr>
	<form action="remove.jsp">
	...
	session.setAttribute("total",Integer.parseInt(session.getAttribute("total").toString())+Integer.parseInt(session.getAttribute("item4_price").toString()));
	%>
	<tr>
	<form action="remove.jsp">
	...
	session.setAttribute("total",Integer.parseInt(session.getAttribute("total").toString())+Integer.parseInt(session.getAttribute("item5_price").toString()));
	%>
	<tr>
	<form action="remove.jsp">
	...
	session.setAttribute("total",Integer.parseInt(session.getAttribute("total").toString())+Integer.parseInt(session.getAttribute("item6_price").toString()));
	%>
	<tr>
	<form action="remove.jsp">
	...
	session.setAttribute("total",Integer.parseInt(session.getAttribute("total").toString())+Integer.parseInt(session.getAttribute("item7_price").toString()));
	%>
	<tr>
	<form action="remove.jsp">
