...
{$("#p1").hover(function(){
$("#show").css("background-image","url(traditional/traditional-1.jpg)");
$("#head").html("The Traditional Ribbon Delight");
$("#code").html("Cake code: &nbsp&nbsp&nbsp CT1");
$("#price").html("Price: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp	Rs. 500 (per kg)");
$("#desc").html("This a very fancy cake with rich dark chocolate ribbon toppings. A <br/> favorite of many of our customers.");
  });
$("#p2").hover(function(){
$("#show").css("background-image","url(traditional/traditional-2.jpg)");
$("#head").html("Outrageous traditional Cake");
$("#code").html("Cake code: &nbsp&nbsp&nbsp CT2<br/><br/>");
...
$("#p3").hover(function(){
$("#show").css("background-image","url(traditional/traditional-3.jpg)");
$("#head").html("Mocha Fun");
$("#code").html("Cake code: &nbsp&nbsp&nbsp CT3<br/><br/>");
$("#price").html("Price: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp	Rs. 600 (per kg)");
$("#desc").html("Rich traditional cake with a delightful mocha flavour. If you like it  <br/> GOBBLE IT ASAP!! Stocks get sold out soon for this one. ");
  });
$("#p4").hover(function(){
$("#show").css("background-image","url(traditional/traditional-4.jpg)");
$("#head").html("Mackennas Gold");
$("#code").html("Cake code: &nbsp&nbsp&nbsp CT4<br/><br/>");
...
$("#p5").hover(function(){
$("#show").css("background-image","url(traditional/traditional-5.jpg)");
$("#head").html("Petits Fours Cake");
$("#code").html("Cake code: &nbsp&nbsp&nbsp CT5<br/><br/>");
...
$("#p6").hover(function(){
$("#show").css("background-image","url(traditional/traditional-6.jpg)");
$("#head").html("Meringues Bonanza");
$("#code").html("Cake code: &nbsp&nbsp&nbsp CT6<br/><br/>");
...
$("#p7").hover(function(){
$("#show").css("background-image","url(traditional/traditional-7.jpg)");
$("#head").html("Cheesecakes");
$("#code").html("Cake code: &nbsp&nbsp&nbsp CT7<br/><br/>");
$("#price").html("Price: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp	Rs. 800 (per kg)");
...
<div id="wrapper">
	...
	<div>
	<a href="#" id="p1"> 
	<img src="traditional/traditional-1.jpg" class="pic1"/>
	</a>
	</div>
	
    <div>
	<img src="traditional/traditional-2.jpg" class="pic" id="p2"/>
	</div>
	
	<div>
	<img src="traditional/traditional-3.jpg" class="pic" id="p3"/>
	</div>
	
	<div>
	<img src="traditional/traditional-4.jpg"  class="pic" id="p4"/>
	</div>
	
	<div>
	<img src="traditional/traditional-5.jpg"  class="pic" id="p5"/>
	</div>
	
	<div>
	<img src="traditional/traditional-6.jpg"  class="pic" id="p6"/>
	</div>
	
	<div>
	<img src="traditional/traditional-7.jpg"  class="pic" id="p7"/>
	</div>
	
	</div>

	<div id="show"style="background-image:url(traditional/traditional-1.jpg)">
	...
	<select name="cartlist">
	  <option value="ct1">The Traditional Ribbon Delight</option>
	  <option value="ct2">Outrageous traditional Cake</option>
	  <option value="ct3">Mocha Fun</option>
	  <option value="ct4">Mackennas Gold</option>
	  <option value="ct5">Petits Fours Cake</option>
	  <option value="ct6">Meringues Bonanza</option>
	  <option value="ct7">Cheesecakes</option>
	</select>
		<select name="qty">
	...
	<p id="code">
	Cake code: &nbsp&nbsp&nbsp CT1<br/><br/>
