...
{$("#p1").hover(function(){
$("#show").css("background-image","url(chocolate/c1.jpg)");
$("#head").html("Chocolate Citrus Tart ");
$("#code").html("Cake code: &nbsp&nbsp&nbsp CCH1<br/><br/>");
$("#price").html("Price: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp	Rs. 1050 (per kg)");
$("#desc").html("A delicious combination of orange and chocolate! <br/>Made with chocolate-flavored tart dough, a rich orange-flavored filling,<br/>and a soft chocolate ganache frosting.");
  });3
$("#p2").hover(function(){
$("#show").css("background-image","url(chocolate/c2.jpg)");
$("#head").html("Chocolate Chip Cookie ");
$("#code").html("Cake code: &nbsp&nbsp&nbsp CCH2<br/><br/>");
$("#price").html("Price: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp	Rs. 1550 (per kg)");
$("#desc").html("Easy and delicious chocolate chip cookie recipe;<br/> a white cookie with added chocolate chips.<br/> If you prefer a dark cookie see the recipe below.");
  });
$("#p3").hover(function(){
$("#show").css("background-image","url(chocolate/c3.jpg)");
$("#head").html("Chocolate Lava Cakes");
$("#code").html("Cake code: &nbsp&nbsp&nbsp CCH3<br/><br/>");
$("#price").html("Price: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp	Rs. 600 (per kg)");
$("#desc").html("Medium dark, rich chocolate cup-cakes with fluid core. <br/>This dessert is often served in fine restaurants<br/> but it is also easy to make at home. ");
  });
$("#p4").hover(function(){
$("#show").css("background-image","url(chocolate/c4.jpg)");
$("#head").html("Classic Chocolate Souffle");
$("#code").html("Cake code: &nbsp&nbsp&nbsp CCH4<br/><br/>");
$("#price").html("Price: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp	Rs. 1800 (per kg)");
$("#desc").html("Easy recipe for a classical chocolate souffle.<br/> For this recipe you can either use plain bittersweet chocolate,<br/> or bittersweet chocolate flavored with orange or raspberries. ");
  });
$("#p5").hover(function(){
$("#show").css("background-image","url(chocolate/c5.jpg)");
$("#head").html("Death By Chocolate  Dark ");
$("#code").html("Cake code: &nbsp&nbsp&nbsp CCH5<br/><br/>");
$("#price").html("Price: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp	Rs. 1700 (per kg)");
$("#desc").html('A dark, extremely rich chocolate layer cake with dark chocolate icing.<br/> The strong chocolate flavor of this cake is amazing!<br/> This is one of our best chocolate cake recipes!');
  });
$("#p6").hover(function(){
$("#show").css("background-image","url(chocolate/c6.jpg)");
$("#head").html("Easy Chocolate Cake  ");
$("#code").html("Cake code: &nbsp&nbsp&nbsp CCH6<br/><br/>");
$("#price").html("Price: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp	Rs. 1250 (per kg)");
$("#desc").html("A rich, medium dark chocolate layer cake.<br/> See also our chocolate layer cake recipe with only cocoa and no chocolate.");
  });
$("#p7").hover(function(){
$("#show").css("background-image","url(chocolate/c7.jpg)");
$("#head").html("Chocolate Layer Cake");
$("#code").html("Cake code: &nbsp&nbsp&nbsp CCH7<br/><br/>");
$("#price").html("Price: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp	Rs. 1200 (per kg)");
$("#desc").html("An easy recipe for a delicious two-layer chocolate cake.");
  });
});
</script>
...
<div id="wrapper">
	...
	<div>
	<a href="#" id="p1"> 
	<img src="chocolate/c1.jpg" class="pic1"/>
	</a>
	</div>
	
    <div>
	<img src="chocolate/c2.jpg" class="pic" id="p2"/>
	</div>
	
	<div>
	<img src="chocolate/c3.jpg" class="pic" id="p3"/>
	</div>
	
	<div>
	<img src="chocolate/c4.jpg"  class="pic" id="p4"/>
	</div>
	
	<div>
	<img src="chocolate/c5.jpg"  class="pic" id="p5"/>
	</div>
	
	<div>
	<img src="chocolate/c6.jpg"  class="pic" id="p6"/>
	</div>
	
	<div>
	<img src="chocolate/c7.jpg"  class="pic" id="p7"/>
	</div>
	
	</div>
	
	<div id="show" style="background-image:url(chocolate/c1.jpg)">

	</div>
	    <div id="cartopt">
	<form onclick="anni.jsp">
	<select name="cartlist">
	  <option value="cch1">Chocolate Citrus Tart</option>
	  <option value="cch2">Chocolate Chip Cookie</option>
	  <option value="cch3">Chocolate Lava Cakes</option>
	  <option value="cch4">Classic Chocolate Souffle</option>
	  <option value="cch5">Death By Chocolate  Dark</option>
	  <option value="cch6">Easy Chocolate Cake</option>
	  <option value="cch7">Chocolate Layer Cake</option>
	</select>
		<select name="qty">
	...
	<p id="price">
	Price: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp	Rs. 1050 (per kg)	</p>
	<p id="code">
	...
	<p id="desc">
	 A delicious combination of orange and chocolate! <br/>Made with chocolate-flavored tart dough, a rich orange-flavored filling,<br/>and a soft chocolate ganache frosting.
	</p>
    </div>	
    </div>
